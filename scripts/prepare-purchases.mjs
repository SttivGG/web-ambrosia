...
const path =
  'artifacts/backups/inventory-before-3-' +
...
writeFileSync('artifacts/phase3/original-inventory.json', before);
const evidence = {
...
writeFileSync(
  'artifacts/purchases-migration.json',
...
console.log(
  'PASS migración limpia, actualización 2B, deploy idempotente y datos locales conservados.',
);
