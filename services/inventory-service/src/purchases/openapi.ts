...
const httpError = purchaseErrorV1Schema.extend({
  code: z.union([
    purchaseErrorV1Schema.shape.code,
    z.enum([
  ...
  return applyDecorators(
    ApiOperation({
      description:
        'Permiso: ' +
        permission +
        '. Cookies requieren CSRF y origen permitido. expectedVersion protege ediciones y transiciones. 409 exige consultar el estado; no hay reintentos automáticos. Cantidades en unidad base, dinero COP como texto; total calculado por servidor.',
    }),
